...
const nodes: IconNode[] = [
  ...
  { id: "bookshelf", label: "bookshelf",  desc: "digital library",                                  image: iconBookshelf, href: "/bookshelf",                                           kind: "internal", left: "24%", top: "38%", tilt: 12,  bobDur: 4.8, bobDelay: 0.3, sizePx: 132 },
  ...
  { id: "vibecoded", label: "vibecoded",  desc: "vibecoded projects",                              image: iconVibecoded, href: "/vibecoded",                                             kind: "internal", left: "36%", top: "68%", tilt: -8,  bobDur: 4.2, bobDelay: 0.5, sizePx: 120 },
